...
?>
    <div class=" bg-success-subtle">
        <div class="container py-5">
            <form name="updateForm" method="post" action="" enctype="multipart/form-data" onsubmit="return validation()">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" maxlength="50" value="<?php echo $idData['title']; ?>">
                    <div id="titleWarn" class="form-text text-danger"></div>
                </div>
                <div class="mb-3">
                    <label for="desc" class="form-label">Blog Description</label>
                    <textarea class="form-control" id="desc" name="desc" rows="8" required><?php echo $idData['description']; ?></textarea>
                    <div id="descWarn" class="form-text text-danger"></div>
                </div>
                <div class="mb-3">
                    <label for="author" class="form-label">Author</label>
                    <input type="text" class="form-control" id="author" name="author" maxlength="15" value="<?php echo $idData['author']; ?>" required>
                ...
                <div class="mb-3 d-flex justify-content-start">
                    ...
                    <div class="mx-4 border border-2 border-success rounded overflow-hidden" style="width:100px; height:100px;">
    ...
    <script>
        const validation = (e)=>{
            const title = document.updateForm.title.value;
            const desc = document.updateForm.desc.value;
            const author = document.updateForm.author.value;
