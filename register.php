...
<body>
  ...
  <div class="container py-5">
    ...
    <form name="regisForm" method="post" action="" novalidate>
      <div class="mb-3">
  ...
  <script>
    $(document).ready(function () {
      $("form").submit(function () {
        ...
        $("#phoneNo").removeClass("outline");
        $("#cPassword").removeClass("outline");
        ...
        if (name.length > 25 || name == "") {
          ...
          $('#nameWarn').text("Name must not be greater than 25 characters and cannot be blank.");
          return false;
        }

        if (phoneNo.length > 11 || phoneNo == "") {
          $('#phoneNo').addClass('outline');
          $('#phoneNoWarn').text("Phone number must not greater than 11 characters and cannot be blank.");
          return false;
        }
        if (password != cPassword || password == "" || cPassword == "") {
          $('#password').addClass('outline');
          $('#cPassword').addClass('outline');
          $('#cPassWarn').text("Must be same as Password and both the field cannot be blank.");
          return false;
        }
      })
    })
